...
namespace supersonic_flat_plate {
    ...
    SupersonicFlatPlate::SupersonicFlatPlate() : imax_(IMAX), jmax_(JMAX), maccormack_solver_(IMAX, JMAX)
    {
    ...
    SupersonicFlatPlate::~SupersonicFlatPlate()
    {
    }

    double SupersonicFlatPlate::CalcXStep(const FlowParameters& params, int size) {
        return params.plate_length / size;
    }

    double SupersonicFlatPlate::CalcYStep(const FlowParameters& params, int size) {
